...
import com.learning.spring_batch.decider.ReceiptDecider;
import com.learning.spring_batch.listener.FlowerSelectionStepExecutionListener;
...
public class Configuration {
    ...
    public Step selectFlowersStep() {
        ...
        }).listener(selectFlowerStepExecutionListener()).build();
    }
    ...
    @Bean
    public StepExecutionListener selectFlowerStepExecutionListener() {
    ...
    public Job prepareFlowers() {
        return this.jobBuilderFactory.get("prepareFlowersJob")
        		.start(selectFlowersStep())
        			.on("TRIM_REQD").to(removeThornsStep()).next(arrangeFlowersStep())
        		.from(selectFlowersStep())
        			.on("NO_TRIM_REQD").to(arrangeFlowersStep()).end()
        		.build();
    }
